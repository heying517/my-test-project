export default {
  ...
  ed: {
    ...
    "property-grid": "属性",
    settingsTooltip: "打开调查问卷设置",
    showPanel: "展示面板",
    hidePanel: "隐藏面板",
    navigateToMsg: "您必须导航到：",
    logic: "调查问卷逻辑",
    saveSurveyTooltip: "保存调查问卷",
    undoTooltip: "撤消上一次更改",
    redoTooltip: "重做更改",
    copy: "复制",
    cut: "剪切",
    ...
    lg: {
      ...
      // Logic tab strings
      page_visibilityName: "页面可见性",
      panel_visibilityName: "面板可见性",
      panel_enableName: "面板启用/禁用",
      question_visibilityName: "问题可见性",
      question_enableName: "启用/禁用问题",
      question_requireName: "必填问题",
      trigger_completeName: "完成调查",
      trigger_setvalueName: "设置问题值",
      trigger_copyvalueName: "复制问题值",
      trigger_skipName: "跳过提问",
      trigger_runExpressionName: "运行自定义表达式",
      completedHtmlOnConditionName: "自定义谢谢您的页面文字",

      page_visibilityDescription:
        "当逻辑表达式返回true时，使页面可见。否则，使其不可见。",
      panel_visibilityDescription:
        "当逻辑表达式返回true时，使面板可见。否则，使其不可见。",
      panel_enableDescription:
        "使面板及其中的所有元素在逻辑表达式返回true时启用。否则将其禁用。",
      question_visibilityDescription:
        "当逻辑表达式返回true时，使问题可见。否则，使其不可见。",
      question_enableDescription:
        "当逻辑表达式返回true时，使问题启用。否则，将其禁用。",
      question_requireDescription: "当逻辑表达式返回真时，将成为必需的问题。",
      trigger_completeDescription:
        "当逻辑表达式返回true时，调查就完成了，最终用户看到了“谢谢页面”。",
      trigger_setvalueDescription:
        "当逻辑表达式中使用的问题值发生更改并且逻辑表达式返回true时，该值将设置为所选问题。",
      trigger_copyvalueDescription:
        "当逻辑表达式中使用的问题值更改并且逻辑表达式返回true时，则将一个选定问题的值复制到另一个选定问题。",
      trigger_skipDescription:
        "当逻辑表达式返回true时，调查将跳过/集中于所选问题。",
      trigger_runExpressionDescription:
        "当逻辑表达式返回true时，将执行自定义表达式。您可以选择将此表达式结果设置为所选问题",
      completedHtmlOnConditionDescription:
        "如果逻辑表达式返回true，则“谢谢页面”的默认文本将更改为给定的文本。",

      itemExpressionText: "当表达式：'{0}' 返回true：", // {0} - the expression
      ...
      question_requireText: "要求输入问题 {0}", // {0} question name
      trigger_completeText: "调查已完成",
      trigger_setvalueText: "设置为问题：{0} 值 {1}", // {0} question name, {1} setValue
      trigger_copyvalueText:
        "复制到问题中：问题 {0} 中的 {1} 值", // {0} and {1} question names
      trigger_skipText: "问卷调查跳至问题 {0}", // {0} question name
      trigger_runExpressionText1: "运行表达式：'{0}'", // {0} the expression
      trigger_runExpressionText2: "并将其结果设置为问题：{0}", // {0} question name
      completedHtmlOnConditionText: "显示“谢谢您的页面”的自定义文本。",

      conditions: "条件(s)",
      actions: "动作(s)",
      expressionEditorTitle: "定义条件(s)",
      actionsEditorTitle: "定义动作(s)",

      deleteAction: "删除动作",
      addNewAction: "添加新动作",
      selectedActionCaption: "选择要添加的操作...",

      expressionInvalid: "逻辑表达式为空或无效。请更正它。",
      noActionError: "请添加至少一项操作。",
      actionInvalid: "请修复您的操作中的问题。",
      expressionSetup: "",
      actionsSetup: "",
    },
  },
  ...
  pe: {
    ...
    placeHolder: "占位文本",
    showPreview: "是否显示预览？",
    allowImagesPreview: "是否显示图片预览",
    waitForUpload: "是否等待上传",
    ...
    tabs: {
      ...
      numbering: "编号",
      pages: "页面",
      completedHtmlOnCondition: "完成条件的Html",
      ...
      layout: "布局",
      data: "数据",
      validation: "当前问卷完成或点击下一页时",
      cells: "单元格",
      showOnCompleted: "在完成后展示",
      logo: "Logo设置",
      slider: "滑动条",
      others: "其他",
    },
    ...
    titlePlaceholder: "在此处输入标题",
    surveyTitlePlaceholder: "在此输入问卷标题",
    pageTitlePlaceholder: "在此输入页面标题",
    descriptionPlaceholder: "在此输入描述",
    surveyDescriptionPlaceholder: "在此输入问卷描述",
    pageDescriptionPlaceholder: "在此输入页面描述",

    isAllRowRequired: "所有行都为必填",
    cols: "列数",
    buildExpression: "生成",
    editExpression: "编辑",
    and: "和",
    ...
    titleKeyboardAdornerTip: "按Enter键进行编辑",
    keyboardAdornerTip:
      "按Enter键编辑项目，按Delete按钮删除项目，按Alt +向上箭头或向下箭头移动项目",
    triggerGotoName: "转到问题：",
    triggerRunExpressionEmpty: "请输入一个有效的表达式",
  },
  pv: {
    true: "真",
    false: "假",
    ...
    singlePage: "单页",
    standard: "标准",
    questionPerPage: "每页问题",
    noPreview: "无预览",
    showAllQuestions: "显示所有问题的预览",
    showAnsweredQuestions: "显示带有已回答问题的预览",
  },
